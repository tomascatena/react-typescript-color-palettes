...
import Default, { SinglePalettePage } from './SinglePalettePage';
import React from 'react';
import seedPalettes from '@data/seedPalettes';

export default {
  title: 'Pages/SinglePalettePage',
  component: SinglePalettePage,
} as ComponentMeta<typeof SinglePalettePage>;
